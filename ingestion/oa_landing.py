...
def ejecutar_peticion_oa(id_tarea: int, api: str | None) -> dict[str, Any]:
    """
    ...
    for attempt in range(MAX_RETRIES):
        try:
            ...
            r.raise_for_status() # es un guard. No devuelve nada util - None, si status 4xx/5xx -> HTTPError para Except
...
def guardar_crudo(datos: dict[str, Any], id_tarea: int) -> Path:
    """
