...
statements = [
    ...
    FROM (
    SELECT * FROM IA_PAISES.RAW.OPENALEX_PUBLICATIONS  WHERE YEAR BETWEEN 2019 AND 2023
    UNION ALL
    SELECT * FROM IA_PAISES.RAW.WORLDBANK_INDICATORS    WHERE YEAR BETWEEN 2019 AND 2023
    UNION ALL
    SELECT * FROM IA_PAISES.RAW.BIGQUERY_PATENTS        WHERE YEAR BETWEEN 2019 AND 2023
    ) k
